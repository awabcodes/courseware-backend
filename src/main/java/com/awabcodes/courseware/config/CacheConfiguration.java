package com.awabcodes.courseware.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.awabcodes.courseware.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.awabcodes.courseware.repository.UserRepository.USERS_BY_EMAIL_CACHE);
